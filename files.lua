...
-- Requirements : table (key : tas name [has to be a root folder], value : array of files without lua extension)
-- Why : io.popen not available in BizHawk and can't juggle with LuaFileSystem on multi os
return {
    ['hayato-lessons'] = {
        '0-init',
        '1-basic-movement',
